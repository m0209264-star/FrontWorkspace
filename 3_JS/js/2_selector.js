...
document.querySelector("#id").onclick = function(){
    ...
    var li = document.getElementById("myli2"); // id값과 일치하는 1개의 요소 선택
    // 2. querySelector('css선택자') css선택자와 일치하는 요소 1개 선택
    var li = document.querySelectorALl(".myli2");
    ...
    // - 단, 모든브라우저에서 지원하지 않고, 또다른 변수와 이름이 충돌할 수 있기 때문에
    //   주의해야 한다.
...
document.querySelector('#email-confirm').onclick = function(){
    // 아이디로 접근
    var userEmail1 = document.querySelector("#userEmail");
