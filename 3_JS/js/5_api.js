...
test4.onclick = function(){
    ...
    console.log(7 - "7"); // 0, nubmer
    console.log(7 * "7"); // 49, number
    console.log(7 / "7"); // 1
    console.log(7 % '4'); // 3
    // 즉, +을 제외한 산술연산시 문자열은 nubmer자료형으로
    // 자동형변환된다.

    console.log(7 % 'a'); // 숫자형태가 아닌 문자열을 숫자로 형변환시
    // 반환되는 값 (NaN). NaN과 기타 값들간의 연산결과는 항상 NaN이 반환
...
test5.onclick = function(){
    ...
    // Number는/실수로 변환이 가능. 단, 변환불가 문자가 있는 경우 NaN을 반환
...
test8.onclick = function(){
   ...
   console.log(null === undefined); // f 자료형다름
   // console.log([] === 0);
